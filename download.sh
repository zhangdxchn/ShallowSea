...
nohup wget -m -c -np -k -E -p https://www.elastic.co/guide/en/elasticsearch/reference/current/index.html > es.log 2>&1 &
...
#nohup wget -m -c -np -H -D ci.apache.org,cdnjs.cludflare.com,maxcdn.bootstrapcdn.com -k -E -p https://ci.apache.org/projects/flink/flink-docs-release-1.8/ > flink.log 2>&1 & 
...
#nohup wget -m -c -np -H -D maxcdn.bootstrapcdn.com,cdnjs.cloudflare.com,neo4j.com -k -E -p https://neo4j.com/docs/getting-started/current/ > neo4j.log 2>&1 &
#nohup wget -m -c -np -H -D maxcdn.bootstrapcdn.com,cdnjs.cloudflare.com,neo4j.com -k -E -p https://neo4j.com/docs/developer-manual/3.4/  > neo4j.log 2>&1 &
